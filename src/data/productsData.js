...
export const manufacturerSpecies = ['AMD', 'AsRock', 'Bitmain', 'Innosilicon', 'Canaan', 'Baikal', 'Boundary Electric', 'Sunbelt', 'Whatsminer', 'iBeLink', 'Nvidia', 'Pandaminer', 'Ebit', 'Dayun', 'Bitfury']
export const equipmentSpecies = ['ASIC miners', 'Video Cards', 'GPU Enclosures', 'Used rigs', 'Power Supplies', 'Hardware wallets', 'Motherboards', 'Containers', 'Accessories',];
export const coinsSpecies = ['bch', 'bsd', 'btc', 'pac', 'pirl', 'ppc', 'ryo', 'start', 'tzc', 'ubq', 'vivo', 'vtc', 'xdn', 'xmcc', 'xmr', 'xmy', 'xvg', 'xzc', 'zcl', 'zec', 'zen', 'nlg', 'music', 'mona', 'ltc', 'kmd', 'hush', 'generic', 'gbx', 'ftc', 'flo', 'exp', 'etp', 'eth', 'etc', 'ella', 'dcr', 'crw', 'btx', 'btg', 'btcp',];
